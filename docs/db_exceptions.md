...
The db_exceptions module contains:
  ...
  + [ExclusionConstraintException](#ExclusionConstraintException)
...
***
<a name="ExclusionConstraintException" href="#ExclusionConstraintException"></a>
```d
class ExclusionConstraintException: object.Exception;
...
***
<a name="ExclusionConstraintException.this" href="#ExclusionConstraintException.this"></a>
```d
this(string msg, string file = __FILE__, size_t line = __LINE__, Throwable next = null);
...
Copyright :copyright: 2015 | Page generated by [Ddoc](http://dlang.org/ddoc.html) on Mon Nov 16 21:29:03 2015
