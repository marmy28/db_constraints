...
```d
final const pure nothrow bool violatesExclusionConstraints(in T item, out string constraintName);

final const pure nothrow bool violatesExclusionConstraints(in T item);
